$(document).ready(function () {
	...
	// If there is a class focus in the page, let's give it the damn focus !
	if($('.focus').length > 0) { $('.focus').focus(); }
	// $.each($('.absolute.wrap-it'), function(index, el) {
	// 	console.log(el);
	// })
	// fullScreen();
});
...
/**
 * Add to the HTML tag in DOM the current browser and mobile
 */
